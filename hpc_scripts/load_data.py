...
def load_nu(batch_size, i, n, federated=True, width=80, height=45):
    ...
    train_dataloader = DataLoader(tr_splits[i], batch_size=batch_size, num_workers=8, shuffle=True)
    test_dataloader = DataLoader(te_splits[i], batch_size=batch_size, num_workers=8, shuffle=True)  
