...
echo "Clearing existing label files in /home/ubuntu/tests/carla/labels..."
rm -f /home/ubuntu/tests/carla/labels/*

# Navigate to the working directory
echo "Navigating to the working directory at /home/ubuntu/tests/..."
cd /home/ubuntu/tests/ || exit
...
python3 data_prep.py --labels="/home/ubuntu/tests/carla/labels.csv" --target_dir="/home/ubuntu/tests/carla/labels" --fractions="$clients"
